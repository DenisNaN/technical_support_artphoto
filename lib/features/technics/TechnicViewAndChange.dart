...
//   late TechnicEntity _oldTechnicForHistory;
//
...
//   void initState() {
//     super.initState();
//     _oldTechnicForHistory = TechnicEntity(
//         widget.technic.id,
...
//         widget.technic.dateChangeStatus,
...
//     List listTestDrive = [];
//     TechnicEntity.testDriveList.forEach((element) {
...
//   }
//
//   void _save (TechnicEntity technic) async{
...
//       TechnicEntity.testDriveList.clear();
//       TechnicEntity.testDriveList.addAll(await ConnectToDBMySQL.connDB.getAllTestDrive());
//     }
//     if(_isEditTestDrive){
...
//   }
//
//   Future addHistory(TechnicEntity technic) async{
...
//   }
//
//   String descriptionForHistory(TechnicEntity technicOld, TechnicEntity technicNew){
