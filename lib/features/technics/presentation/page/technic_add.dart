...
class _TechnicAddState extends State<TechnicAdd> {
                    ...
                    ElevatedButton(
                        onPressed: () async {
                          if (_formInnerNumberKey.currentState!.validate()) {
                            TechnicModel technic = TechnicModel.withoutTestDrive(
                                0,
      ...
      children: [
        Column(
          children: [
            SizedBox(height: 10,),
            Text('Б/Н'),
            Checkbox(value: true, onChanged: (isValue){
  ...
  Future _save(TechnicModel technicModel, ProviderModel providerModel) async {
    ...
    Technic technic = Technic(
        technicModel.id!, technicModel.internalID!, technicModel.category,
  ...
  Future addHistory(TechnicModel technic, String nameUser) async {
  ...
  String descriptionForHistory(TechnicModel technic) {
