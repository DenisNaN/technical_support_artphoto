...
class FiltersForTechnic extends StatefulWidget {
  final Map filtMap;
  const FiltersForTechnic({super.key, required this.filtMap});

  @override
  State<FiltersForTechnic> createState() => _FiltersForTechnicState();
}

class _FiltersForTechnicState extends State<FiltersForTechnic> {
